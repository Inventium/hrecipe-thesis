...
function is_pre_page_hooks($bodyclass = '') {

  if ($bodyclass) {
    global $post;
    // Be careful here, delete_post_meta will delete all
    // thesis_slug keys unless passed a specific value to delete.
    // Note that if a specific page has a class specified, it
    // will override what is specified here.
    delete_post_meta($post->ID,'thesis_slug', $bodyclass);  
    add_post_meta($post->ID, 'thesis_slug', $bodyclass);
  }
...
<?php
  thesis_head::build();
  // thesis_body_classes() is located in lib/functions/document.php
...
function page_header_nofooter_nosidebar_18($bodyclass = '') {

  is_pre_page_hooks($bodyclass);
...
///////  THESIS 1.8 ////////////////////
function page_noheader_nofooter_nosidebar_18($bodyclass = '') {
...
function page_header_footer_nosidebar_18($bodyclass = '') {
...
function page_header_footer_sidebar_18($bodyclass = '') {
...
function page_header_footer_sidebar2_18($bodyclass = '') {
